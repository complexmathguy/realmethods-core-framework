 ...
 */
public class ResultsetToStringUnloader 
...
//*****************************************
        ...
        throws ResultSetCallbackException
    {
            ...
            if ( rs.next() == true )
            {
                ...
                do
                {
                    ...
                    while (fieldNameIterator.hasNext())
                    {
                        ...
                        currentFieldValue = rs.getString(currentFieldName);
        ...
        {
            throw new ResultSetCallbackException( "ResultsetToStringUnloader:notifyResultSet(ResultSet,String) - " + exc, exc );
        }
...
/*
 * Change Log:
 * $Log: ResultsetToStringUnloader.java,v $
 */
